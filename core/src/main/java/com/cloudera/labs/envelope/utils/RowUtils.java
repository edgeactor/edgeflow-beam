        ...
        switch (typeName) {
            ...
            case "date":
                ...
                if (item instanceof BigDecimal) {
                    return new java.sql.Date(((BigDecimal) item).longValue());
            ...
            case "timestamp":
                // java.sql.Timestamp
                if (item instanceof BigDecimal) {
                    return new Timestamp(((BigDecimal) item).longValue());
                } else if (item instanceof Long) {
            ...
            case "float":
                // float or Float
                if (item instanceof BigDecimal) {
                    return ((BigDecimal) item).floatValue();
            ...
            case "integer":
                // int or Integer
                if (item instanceof BigDecimal) {
                    return ((BigDecimal) item).intValue();
            ...
            case "short":
                // short or Short
                if (item instanceof BigDecimal) {
                    return ((BigDecimal) item).shortValue();
            ...
            case "map":
                ...
                if (item instanceof Map) {
                    ...
                    return JavaConverters.mapAsScalaMapConverter(hashMap).asScala();
                } else if (item instanceof Row) {
